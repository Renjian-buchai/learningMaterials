...
<meta name="keywords" content="freeGLUT glut C++ OpenGL Tutorial 2D Linux install freeGLUT g++">
<meta name="description" content="Install OpenGL freeGLUT for Linux command line.">
...
<nav class="container">
    ...
    <a name="1" href="index.php#1">1)</a>Go download the <a href="../../01_hello_freeglut.zip">source for lesson 01</a>. Extract the source somewhere. Now compile by entering this command:<br/>
<code>g++ LUtil.cpp main.cpp -w -lGL -lGLU -lglut -o 01_hello_freeglut</code><br/>
<br/>
