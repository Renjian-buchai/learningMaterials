...
<nav class="container">
    ...
    <h1 class="text-center">Setting up SDL 2 on Linux Android Studio 3.0.1</h1>
...
<br/>
First you need to install the Java Development Kit (JDK). Using apt-get you can install it using the following command:<br/>
<br/>
<code>sudo apt-get install default-jdk</code><br/>
<br/>
<br/>
...
<br/>
<a name="4" href="index.php#4">4)</a> To run on an Android device we're going to need the Android Debug Bridge (known as ADB). You can install it with apt-get using:<br/>
<br/>
<code>sudo apt-get install android-tools-adb</code><br/>
<br/>
<a name="5" href="index.php#5">5)</a> Extract the android-studio folder from the Android Studio zip we downloaded earlier. Put it some place convenient. For this tutorial we will be putting it inside of the home directory.<br/>
<br/>
After it's extracted, install and/or run Android Studio. Instructions on how to do so should be at <code>~/android-studio/Install-Linux-tar.txt</code>.<br/>
<br/>
...
<code>~/androidlib/</code>. After extracting the SDL2 source code you should have an Android makefile at <code>~/androidlib/SDL2-2.0.7/Android.mk</code>.
Depending on your version of SDL, it could be at <code>~/androidlib/SDL2-2.0.5/Android.mk</code> or <code>~/androidlib/SDL2-2.0.4/Android.mk</code> and so on.<br/>
<br/>
...
<code><b>YOUR-HOME-DIRECTORY</b>/androidprojects/SDL_Tutorial</code>. Select the directory and import the project with the default settings.<br/>
<br/>
...
<div class="text-center"><img class="img-fluid" alt="upgrade gradle" src="upgrade_gradle.png"></div>
<br/>
...
<div class="text-center"><img class="img-fluid" alt="link cpp with gradle" src="link_cpp_with_gradle.png"></div>
<br/>
...
<div class="text-center"><img class="img-fluid" alt="select android make" src="select_android_mk.png"></div>
Hit Build -&gt; Make Project and you'll get a bunch of new errors saying something like<br/>
<br/>
<code>Android NDK: Module main depends on undefined modules: SDL2</code><br/>
<br/>
...
<div class="text-center"><img class="img-fluid" alt="" src="open_gradle_console.png"></div>
<br/>
...
<code>~/androidprojects/SDL_Tutorial/app/src/main/jni/Application.mk</code> and change <code># APP_STL := stlport_static</code> to <code>APP_STL := stlport_static</code> so it's no longer commmented out. Build again and you
...
<code>&lt;string name="app_name"&gt;SDL Tutorial&lt;/string&gt;</code>. This will change the name under the App's icon from "SDL App" to "SDL Tutorial".<br/>
<br/>
...
<br/>
<a name="20" href="index.php#20">20)</a> Our SDL application is ready to build and run, but first we need to set up our device. You can use an Android emulator, but the emulator is can be really, really slow so I recommend
